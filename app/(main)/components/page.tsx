...
export default async function ComponentsPage() {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 ml-4 max-w-6xl mx-auto py-8 lg:py-16">
      {await Promise.all(
        components.map(async (component) => {
          ...
          return (
            <Link
              ...
              key={component.slug}
              className="relative flex flex-col justify-between border h-[20rem] rounded-xl p-4 shadow overflow-auto"
            >
