...
import { Archive, Check, Power, ShoppingCart, Star, Trash2, X ,Lock, Unlock, Heart, VolumeX, Volume2, Send, Download} from "lucide-react";

export default function SwipeUseCasesDemo() {
