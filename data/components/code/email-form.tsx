...
const springConfig = { type: "spring", stiffness: 340, damping: 28 };
      ...
      {open ? (
        ...
        >
          ...
          <div className="flex items-center justify-between">
            <motion.div layoutId="drop" className="text-sm font-semibold tracking-tight">
              Drop your Email
            </motion.div>
            <button
        ...
        >
          <motion.span layoutId="drop" className="text-sm font-semibold tracking-tight">
            Drop your Email
          </motion.span>
