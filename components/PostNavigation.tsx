    ...
    >
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
        {prevPost ? (
          ...
          >
            <IconArrowLeft className="text-muted-foreground group-hover:text-foreground h-4 w-4 shrink-0 transition-all duration-200 ease-in-out group-hover:-translate-x-1" />
        ...
        {nextPost && (
          ...
          >
            ...
            <IconArrowRight className="text-muted-foreground group-hover:text-foreground h-4 w-4 shrink-0 transition-all duration-200 ease-in-out group-hover:translate-x-1" />
          </Link>
        )}
      </div>
    </MotionDiv>
