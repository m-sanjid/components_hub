...
const IconHover: React.FC<IconHoverProps> = ({ icon: Icon, className, size = 5, iconClassName }) => {
  return (
    ...
    >
      <div className="inset-0.5 rounded-[6px] border-neutral-300 dark:border-neutral-200 absolute z-20 border opacity-0 group-hover/icon:opacity-100 scale-50 group-hover/icon:scale-100 duration-300  ease-in-out"/>
