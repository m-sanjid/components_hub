...
function TabsContent({
  ...
  return (
    <TabsPrimitive.Content
      ...
      className={cn("flex-1 outline-none border p-2 rounded-md", className)}
      {...props}
    />
  );
}
