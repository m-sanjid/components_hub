...
```bash
npx shadcn@latest add https://ui.sanjid.shop/r/flow-form.json
```
</TabsContent> <TabsContent value="manual"> <Steps>
<Step>Install required dependencies:</Step>

```bash
npm install motion sonner zod react-hook-form @hookform/resolvers nodemailer @tabler/icons-react
```
