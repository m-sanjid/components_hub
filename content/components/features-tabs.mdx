...
<CodePreview
  name="features-tabs"
  title="Features Tabs"
  description="An animated, accessible feature tabs section with autoplay and keyboard navigation."
/>
...
<TabsContent value="cli">
  ```bash npx shadcn@latest add features-tabs --component ```
</TabsContent>
...
✅ Animated tab highlight with spring transitions
...
✅ Headless content: render any JSX inside panels
