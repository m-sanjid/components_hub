...
```bash
npx shadcn@latest add https://ui.sanjid.shop/r/team-gallery.json
```
...
<ComponentSource name="team-gallery" title="components/ui/team-gallery.tsx" />
